        ...
        <div className='flex gap-3'>
          {buttons.map((button, index) => (
            <button
              ...
              className={`p-3 rounded-2xl m-2 font-bold ${selected === index ? 'bg-gray-400 text-black border-gray-400' : 'bg-orange-600 text-white border-orange-400'} hover:bg-gray-400 hover:text-black hover:border-gray-400`}
            >
              {button}
            </button>
          ))}
